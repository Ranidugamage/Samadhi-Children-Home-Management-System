...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `labor`(`name`, `contact`, `address`, `gender`, `birthday`, `nameWithInitials`, `company`) VALUES ('$name','$contact','$address','$gender','$birthday','$fullName','$company')";
...
<div class="container-fluid">
    ...
    <div class="card mt-lg-5 mt-4 w-100">
        ...
        <i class="fas fa-male ps-2"></i> ADD LABOR
        </div>
        <div class="card-body">
            <form class="row g-3 needs-validation" novalidate action="addLabor.php" method="POST" id="myForm">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input pattern="[0-9]{10}" type="tel" class="form-control" id="validationCustom04" required name="contactNo">
                    <div class="invalid-feedback">
                ...
                <div class="col-12">
                    <button class="btn btn-primary px-5 mt-3" name="submit" type="submit">Add Labor</button>
                </div>
                <?php if ($isAdded) : ?>
